...
urlpatterns = [
    ...
    path('detail/<int:pk>/', views.user_course_detail, name="user_course_detail"),
    ...
    path('module/<int:module_id>/content/<model_name>/<id>/update', views.content_create_update_view,
